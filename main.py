...
from myUtilityDefs import convert_to_new_dictionary, print_sentiments, get_sentiment_emoji, readAMDFileAndReturnBuffer
from os import path
...
with st.sidebar:
    ...
    pocAction = st.button('POCSummary', key=99)
    sentiment_models = {
...
def main():
    ...
    if pocAction:
        st.markdown(''.join(readAMDFileAndReturnBuffer('poc_summary.md')))
